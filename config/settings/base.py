...
DATABASES = {
    "default": env.db(
        "DATABASE_URL",
        default="postgres://localhost/annolab",
    ),
}
...
MIGRATION_MODULES = {"sites": "annolab.contrib.sites.migrations"}
...
# https://django-allauth.readthedocs.io/en/latest/configuration.html
ACCOUNT_ADAPTER = "annolab.users.adapters.AccountAdapter"
# https://django-allauth.readthedocs.io/en/latest/forms.html
ACCOUNT_FORMS = {"signup": "annolab.users.forms.UserSignupForm"}
# https://django-allauth.readthedocs.io/en/latest/configuration.html
SOCIALACCOUNT_ADAPTER = "annolab.users.adapters.SocialAccountAdapter"
# https://django-allauth.readthedocs.io/en/latest/forms.html
SOCIALACCOUNT_FORMS = {"signup": "annolab.users.forms.UserSocialSignupForm"}
...
SPECTACULAR_SETTINGS = {
    "TITLE": "annolab API",
    "DESCRIPTION": "Documentation of API endpoints of annolab",
    "VERSION": "1.0.0",
